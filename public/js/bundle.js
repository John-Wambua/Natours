...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiandhbWJ1YSIsImEiOiJja2N4bWlzdWIwMWluMnltcnh0dXpxN2hwIn0.i_7gvX3d8-kjjLG3JyN9Lw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jwambua/ckcxmpoy710go1iqun3jdwx3l',
    scrollZoom: false // center:[36.8219,-1.2921],
    // zoom:12,
    // interactive:false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, " </p>")).setMaxWidth("300px").addTo(map); //Extend map bounds to include current location
...
var stripe = Stripe('pk_test_51H8Sr9Hl9RpwDW9LKHD27Ph6dJ7ebs7QQBd8jeHs3YEXsyc2LQsDAEQZL6SSRyCE1eIbvg0px3LcotM8ISrvcNbW00kLS6FgSc');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(res.data.session.id); // 2) Create checkout form + charge credit cart
...
var bookButton = document.querySelector('#book-tour'); //DELEGATION
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              newPassword = document.querySelector('#password-new').value;
              newPasswordConfirm = document.querySelector('#password-new-confirm').value;
              _context.next = 7;
